export function AdminDashboardCard({ icon, title, subtitle, firstItem, middleItem, lastItem, buttonText }: { icon: string, title: string, subtitle: string, firstItem: string, middleItem: string, lastItem: string, buttonText: string }) {
  return (
